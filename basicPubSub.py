...
import argparse
import json
import random # used to generate random values to simulate temperature readings
AllowedActions = ['both', 'publish', 'subscribe']

__device_name__ = 'canvas-io controller'
...
parser.add_argument("-M", "--message", action="store", dest="message", default="Hello from the {} ".format(__device_name__),
                    help="Message from {}".format(__device_name__))
